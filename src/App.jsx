        ...
        <header className="rounded-b-[1.75rem] bg-gradient-to-br from-indigo-700 via-indigo-600 to-violet-600 px-4 pb-5 pt-4 text-white sm:px-5">
          <div className="flex items-center justify-between">
            ...
            <div className="relative" ref={menuRef}>
              ...
              {isMenuOpen && (
                <div className="absolute right-0 top-12 w-48 rounded-2xl border border-slate-200 bg-white p-2 text-sm text-slate-700 shadow-lg">
                  <button
                    type="button"
                    onClick={() => {
                      setActiveTab('tasks')
